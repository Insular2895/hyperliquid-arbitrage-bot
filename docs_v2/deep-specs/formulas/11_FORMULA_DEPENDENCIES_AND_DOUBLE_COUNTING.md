...
## CORR-06 global-close guard

QF-106 is the general global close. QF-108's strategy subtotal cannot hide or absorb Bridge/Relocation. The QF-108 compact economic equality is bridge-free scoped; a period with Bridge uses QF-106 and records the Bridge bucket once. Read/gossip-priority auction cost is an infrastructure/feed experiment cost; an IOC/ALO write-priority charge belongs once to its affected order scenario. Neither cost may appear in two buckets.
