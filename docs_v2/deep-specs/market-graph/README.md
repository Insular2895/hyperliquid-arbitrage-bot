...
1. [Structural graph, venues, assets and markets](01_STRUCTURAL_GRAPH_VENUES_ASSETS_AND_MARKETS.md)
2. [Directed conversion edges and NetConvert](02_DIRECTED_CONVERSION_EDGES_AND_NETCONVERT.md)
3. [Route types and classification](03_ROUTE_TYPES_DIRECT_OWA_TRIANGLE_AND_BRIDGE_BOUNDARY.md)
4. [Precomputation, reverse index and invalidation](04_ROUTE_PRECOMPUTATION_PAIR_TO_ROUTES_AND_INVALIDATION.md)
5. [Opportunity detection and size economics](05_OPPORTUNITY_DETECTION_AND_SIZE_DEPENDENT_ECONOMICS.md)
6. [Activation, HWC and Global Watcher](06_ROUTE_ACTIVATION_HOT_WARM_COLD_AND_GLOBAL_WATCHER.md)
