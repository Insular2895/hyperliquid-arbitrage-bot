...
| [13](13_HOT_PATH_PERFORMANCE_AND_WORK_ELIMINATION.md) | CORR-02 work elimination, memory, concurrency and optimization gates |
| [14](14_ASYNC_CONCURRENCY_AND_ORDERED_COMMIT.md) | C0–C5 classes, bounded workers/effects, stale results and ordered commit |
